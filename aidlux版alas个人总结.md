...
此攻略适用于：安卓11及以上安卓手机；其余环境自测

测试环境：Redmi Note 12T Pro 天玑8200-U 安卓13 

Aidlux 版本： 2.1.0

##### 受制于aidlux的性能优化，并不推荐使用此方案

本教程要求您有一定的代码基础、玩机经验与足够的折腾耐心
...
##### aidlux性能优化较差，与游戏本体同时运行时极易被杀后台！若设备性能较差，建议转为termux方案

###### 实测：三星zflip5 (骁龙8Gen2) 8G内存版魔改无屏幕盒子+主动散热运行工况：整机功耗10W左右，VMOS虚拟机和aidlux无法长期同时运行，难以满足长期无人值守挂机需求
